...
(function () {
    ...
    var basicBot = {
        ...
        chatLink: "https://rawgit.com/MennoP/VRplugbot/master/lang/en.json",
        chat: null,
        loadChat: loadChat,
        ...
        eventVoteupdate: function (obj) {
			...
			var currentUsers = API.getUsers().length;

            if (basicBot.settings.voteSkip) {
				if (mehs > woots) {
					if ( (mehs) >= (currentUsers * 0.4)) {
						API.sendChat(subChat(basicBot.chat.voteskipexceededlimit, {name: dj.username, limit: (currentUsers * 0.4)}));
			...
			manmanCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.manman)
                    }
                }
            },
			...
			goleCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
						...
						var i = Math.floor((Math.random() * basicBot.chat.gole.length))
                        API.sendChat(basicBot.chat.gole[i])
                    }
                }
            },
			...
			druseraCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
						...
						var i = Math.floor((Math.random() * basicBot.chat.drusera.length))
